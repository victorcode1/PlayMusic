...
import com.soft.playmusic.adapters.BaseSongAdapter;
...
public class TimberUtils {
    ...
    public static void showDeleteDialog(final Context context,
                                        final String name, final long[] list, final BaseSongAdapter adapter, final int pos) {
